...
int main() {
	...
	plotadienis(x1, y1, x2, y2, x3, y3, plotas, perimetras);
	cout << fixed << setprecision(5) << plotas << endl << perimetras;

}

void plotadienis(double x1, double y1, double x2, double y2, double x3, double y3, double & plotas, double & perimetras) {
